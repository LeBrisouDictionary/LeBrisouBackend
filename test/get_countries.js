...
Lab.experiment("Get Countries", function() {
  var options = {},
      server,
      delay = 0
  ...
  Lab.test("All countries", function (done) {
  ...
  Lab.test("All countries with limit", function (done) {
  ...
  Lab.test("All countries extended", function (done) {
    options.url = '/api/countries?extended=true'
  ...
  Lab.test("All countries extended and limit ", function (done) {
    options.url = '/api/countries?extended=true&limit=2'
